sap.ui.define([
	...
	return {
		...
		ValueHelp: function (oEvent, params, oView) {
			...
			oView.oColModel = new JSONModel(sap.ui.require.toUrl("com/ey/bamlocprdattr/model") + params.Columns);
			...
			oView._oValueHelpDialog = sap.ui.xmlfragment("com.ey.bamlocprdattr.fragment." + params.Fragment, oView);
