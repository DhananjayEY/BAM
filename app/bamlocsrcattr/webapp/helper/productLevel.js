sap.ui.define([
	...
	return {
		ValueHelp: function (oEvent, oView) {  /* oView is 'this' passed from the controller */
			oView.oProductColModel = new JSONModel(sap.ui.require.toUrl("com/ey/bamlocsrcattr/model") + "/columnsPrdLvl.json");
			...
			oView._oProductValueHelpDialog = sap.ui.xmlfragment("com.ey.bamlocsrcattr.fragment.DialogProductLevel", oView);
