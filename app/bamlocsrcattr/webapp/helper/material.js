sap.ui.define([
	...
	return {
		...
		ValueHelp: function (oEvent, params, oView) {
			...
			oView.oColModel = new JSONModel(sap.ui.require.toUrl("com/ey/bamlocsrcattr/model") + params.Columns);
			...
			oView._oValueHelpDialog = sap.ui.xmlfragment("com.ey.bamlocsrcattr.fragment." + params.Fragment, oView);
